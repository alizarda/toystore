<?php   										// Opening PHP tag
	...
	function get_all_toys(PDO $pdo) {
		...
		// SQL query to retrieve all toy information
		$sql = "SELECT * FROM toy;";
	
		// Execute the SQL query using the pdo function and fetch all results
		$toys = pdo($pdo, $sql)->fetchAll();
	
		// Return the toy information (array of associative arrays)
		return $toys;
	}
	
	// Retrieve info about all toys from the db using provided PDO connection
